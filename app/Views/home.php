    ...
    <?php foreach ($grouped as $category => $items): ?>
      ...
      <section class="mb-5">
        ...
        <div id="carousel-<?= $category ?>" class="carousel slide" data-bs-ride="false">
                      ...
                      <div class="card h-100 shadow-sm border-0">
                        ...
                        <div class="card-body text-center">
                          ...
                          <p class="card-text text-muted">
                            <?= htmlspecialchars($product->getShortDescription()) ?>
                          </p>
                        ...
                        <div class="card-footer bg-transparent border-0">
                          ...
                          <!-- Botão que abre o modal do carrinho -->
                          <button type="button"
                            class="btn btn-outline-primary w-100 my-1 rounded-pill js-open-cart-modal"
          ...
          <!-- Controles -->
          <button class="carousel-control-prev position-absolute align-self-center d-none d-md-block d-lg-block"
                  style="left: -11%; height: 15%" type="button"
          ...
          <button class="carousel-control-next position-absolute align-self-center d-none d-md-block d-lg-block"
                  style="right: -8%; height: 15%" type="button"
...
<?php include __DIR__ . '/products/components/cart-modal.php'; ?>

<script>
// JS do modal de carrinho (puro)
(function () {
