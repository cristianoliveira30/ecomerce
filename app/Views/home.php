    ...
    <?php foreach ($grouped as $category => $items): ?>
      ...
      <section class="mb-5">
        ...
        <div id="carousel-<?= $category ?>" class="carousel slide" data-bs-ride="false">
                    ...
                    <div class="col-md-3">
                      <div class="card h-100 shadow-sm border-0">
                        ...
                        <div class="card-footer bg-transparent border-0">
                          ...
                          <a href="/produto/<?= htmlspecialchars($product->getSlug()) ?>" class="btn btn-outline-primary w-100 my-1 rounded-pill">
          ...
          <!-- Controles -->
          <button class="carousel-control-prev position-absolute align-self-center d-none d-md-block d-lg-block" style="left: -11%; height: 15%" type="button" data-bs-target="#carousel-<?= $category ?>" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
          ...
          <button class="carousel-control-next position-absolute align-self-center d-none d-md-block d-lg-block" style="right: -8%; height: 15%" type="button" data-bs-target="#carousel-<?= $category ?>" data-bs-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="text-dark">
